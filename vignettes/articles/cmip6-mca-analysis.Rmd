...
make_figures <- function(pattern, title, tsfm, hot, fun) {
  ...
  ggsave(
   glue::glue("./figures/{out_base}_map.png"), fig, width=8, height=6, bg = "white"
  )
  ...
  dat <- make_heatmap_data(
    ...
    dplyr::mutate(area = climdiv_to_factor(area))
  fig <- apply_heatmap_by_scenario(dat, hot, title)
  ggsave(
...
tibble::tribble(
  ...
  "freeze-free.tif", "Change in # of Freeze-Free Days", NULL, FALSE, "sum",
